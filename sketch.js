...
//creating the canvas and adjust the window sizes to suit the device 
...
function createCar() {
  if (World.frameCount % 200 == 0) {
   // Modifing the positions of cash 
...
function createanimal(){
  if (World.frameCount % 530 == 0) {
    //   Modifing the positions of sword to make them spawn throughout the available screen size.
